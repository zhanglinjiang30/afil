...
public class ActivemqConfig {
    ...
    /********短信********************************************************************************************************/
    @Bean
    public Topic queueBlock() {
        return new ActiveMQTopic(MqConstant.MQ_SEND_BLOCK);
    }

    @Bean
    public Topic queueActive() {
        return new ActiveMQTopic(MqConstant.MQ_SEND_ACTIVE);
    }
    ...
    @Bean
    public Destination queueToken() {
        return new ActiveMQTopic(MqConstant.MQ_CLEAR_TOKEN);
    }
