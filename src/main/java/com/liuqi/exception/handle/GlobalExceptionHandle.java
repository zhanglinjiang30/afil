...
public class GlobalExceptionHandle {
    ...
    public ReturnResponse illegalArgumentException(HttpServletRequest request,IllegalArgumentException ex) {
        System.out.println("--->"+request.getRequestURI());
        ex.printStackTrace();
    ...
    public ReturnResponse exception(HttpServletRequest request,Exception ex) {
        System.out.println("--->"+request.getRequestURI());
        ex.printStackTrace();
        String msg=ex.getMessage();
        msg= StringUtils.isNotEmpty(msg)&& msg.length()>100?msg.substring(0,100):msg;
