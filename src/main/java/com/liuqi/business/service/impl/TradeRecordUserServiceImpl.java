...
//        dto.setUserName(userService.getNameById(dto.getUserId()));
        CurrencyTradeModelDto currencyTradeModelDto = currencyTradeService.getById(dto.getTradeId());
        if (currencyTradeModelDto != null){
            dto.setTradeName(currencyTradeModelDto.getTradeCurrencyName()+"/"+currencyTradeModelDto.getCurrencyName());
            dto.setTradeCurrencyName(currencyTradeModelDto.getTradeCurrencyName());
            dto.setCurrencyName(currencyTradeModelDto.getCurrencyName());
        }
    }
