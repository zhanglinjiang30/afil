...
public interface UserService extends BaseService<UserModel, UserModelDto> {
     ...
     * @param code
     */
    void forgetPassword(String name, String pwd, String code);
     ...
     * @param user
     */
    void register(UserModelDto user);
     ...
     * @param code
     */
    void changeTradePwd(String tradePassword, String newTradePassword, Long userId,boolean checkCode, String code);
