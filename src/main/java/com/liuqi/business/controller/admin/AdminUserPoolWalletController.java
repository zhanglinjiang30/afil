...
@Controller
@RequestMapping("/admin/userPoolWallet")
public class AdminUserPoolWalletController extends BaseAdminController<UserPoolWalletModel,UserPoolWalletModelDto> {
    ...
    //模块
    private final static String BASE_MODUEL="userPoolWallet";
    //默认为""表示可以使用add和update。  重写add或update时，原有方法禁止使用 NOT_OPERATE="add,update"
    private final static String NOT_OPERATE="";
    @Override
    public BaseService getBaseService() {
    	return this.userPoolWalletService;
    }
    ...
    @Override
    protected void toUpdateHandle(UserPoolWalletModelDto t, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) {
        super.toUpdateHandle(t, modelMap, request, response);
        this.getEnumList(modelMap);
    }

    @Override
    protected void toViewHandle(UserPoolWalletModelDto t,ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) {
