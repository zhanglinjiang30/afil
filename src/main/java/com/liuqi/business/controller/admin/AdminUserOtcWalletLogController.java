...
@Controller
@RequestMapping("/admin/userOtcWalletLog")
public class AdminUserOtcWalletLogController extends BaseAdminController<UserOtcWalletLogModel,UserOtcWalletLogModelDto> {
    ...
    //模块
    private final static String BASE_MODUEL="userOtcWalletLog";
    //默认为""表示可以使用add和update。  重写add或update时，原有方法禁止使用 NOT_OPERATE="add,update"
    private final static String NOT_OPERATE="";
    @Override
    public BaseService getBaseService() {
    	return this.userOtcWalletLogService;
    }
    ...
    /*******待修改  排序  导出**********************************************************************************************************/
    //默认导出名称
    private final static String DEFAULT_EXPORTNAME="dasdad";
    @Override
    ...
    @Override
    protected void toUpdateHandle(UserOtcWalletLogModelDto t, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) {
        super.toUpdateHandle(t, modelMap, request, response);
        this.getEnumList(modelMap);
    }

    @Override
    protected void toViewHandle(UserOtcWalletLogModelDto t,ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) {
