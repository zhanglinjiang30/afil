...
//            @ApiImplicitParam(dataType ="String",name="parentName" ,value = "邀请码",required = false,paramType = "query"),
...
//        }
//
//        if(!ValidatorUtil.isMobile(user.getPhoneEmail())&&!ValidatorUtil.isEmail(user.getPhoneEmail())){
//            return ReturnResponse.backFail("请输入正确的手机号或邮箱");
//        }
//        UserModel userTemp = userService.queryByName(user.getPhoneEmail());
//        if (userTemp != null) {
...
//        }
//
//        CodeCache.verifyCode(user.getPhoneEmail(),code);
