...
public class LockConstant {
    ...
    public static final String LOCK_TRANSFER = BASE+"lock:transfer:";
    ...
    public static final String  LOCK_CROWDFUND_BUY=BASE+"lock:crowdfund:buy:";

    public static final String  LOCK_PUBLIC_OFFER_BUY=BASE+"lock:public:offer:buy:";
